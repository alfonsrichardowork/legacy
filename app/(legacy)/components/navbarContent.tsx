...
function NavbarContent (){
    ...
    return(
      loading?
      <div className='grid grid-cols-3 w-[580px] bg-transparent'><div className='w-[190px] bg-background rounded-lg h-fit z-40 p-1 px-2'><Loader size={20} className='animate-spin' /></div></div>
      :
