  ...
  return (
    <>
      <Swiper
          ...
          data-testid="swiper-carousel-cover-catalogues"
          className="mySwiper2 h-full flex items-center"
        >
              {image_catalogues && image_catalogues.length > 0 && image_catalogues.map((item, index) => (
                item.name === 'Top' &&
                  <SwiperSlide key={`${item.name} - Catalogues - ${index}`} data-testid={`swiper-slide-catalogues-${index+1}`}>
      ...
      <div className="z-10 gap-2 flex justify-center items-center pt-2">
        <button
          ...
          data-testid={`swiper-slide-pagination-button-0`}
        ></button>
        {image_catalogues.map((_, index) => (
          <button
            ...
            data-testid={`swiper-slide-pagination-button-${index + 1}`}
          ></button>
        ))}
      </div>
